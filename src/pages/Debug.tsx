...
export default function Debug() {
  ...
  const handleAdminLogin = async () => {
    setIsLogging(true);
    try {
      const result = await signIn("bruno.liraa@icloud.com", "Lira@Lira1990");
  ...
  return (
    <Layout>
      ...
      <section className="bg-primary text-primary-foreground py-16">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Debug</h1>
          </div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <BreadcrumbStandard items={[{ label: "Home", href: "/" }, { label: "Debug" }]} />
        </div>
          ...
          <Card className="max-w-md mx-auto">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                {!user ? (
                  <Button onClick={handleAdminLogin} disabled={isLogging} className="w-full">
